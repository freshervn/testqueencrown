...
//        var y = JSON.stringify(axEventObject);
    ...
    var _showCaseDescriptions = function(elementId, eventInfo, axEventObject, synthetic) {
        ...
        var $container px-md-5 = $("<div class='intcases' id='" + linksId + "'></div>");
        ...
        $container px-md-5.mouseleave(function(e) { $ax.legacy.SuppressBubble(e); });
        $('body').append($container px-md-5);
    ...
    (function() {
        ...
        $ax.event.initKeyEvents = function($query) {
            $query.keydown(function (e) {
                ...
                $ax.setjBrowserEvent(e);
                if (!elementId) fireEventThroughcontainer px-md-5s('onKeyDown', undefined, false, [$ax.constants.PAGE_TYPE, $ax.constants.REFERENCE_DIAGRAM_OBJECT_TYPE, $ax.constants.DYNAMIC_PANEL_TYPE, $ax.constants.REPEATER],
            ...
            $query.keyup(function(e) {
                ...
                if (!elementId) fireEventThroughcontainer px-md-5s('onKeyUp', undefined, false, [$ax.constants.PAGE_TYPE, $ax.constants.REFERENCE_DIAGRAM_OBJECT_TYPE, $ax.constants.DYNAMIC_PANEL_TYPE, $ax.constants.REPEATER],
                    [$ax.constants.PAGE_TYPE, $ax.constants.REFERENCE_DIAGRAM_OBJECT_TYPE, $ax.constants.LAYER_TYPE]);
    ...
    var _loadDynamicPanelsAndMasters = function(objects, path, itemId) {
        fireEventThroughcontainer px-md-5s('onLoad', objects, true, [$ax.constants.PAGE_TYPE, $ax.constants.REFERENCE_DIAGRAM_OBJECT_TYPE, $ax.constants.DYNAMIC_PANEL_TYPE],
    ...
    var _viewChangePageAndMasters = function(forceSwitchTo) {
        fireEventThroughcontainer px-md-5s('onAdaptiveViewChange', undefined, true, [$ax.constants.PAGE_TYPE, $ax.constants.REFERENCE_DIAGRAM_OBJECT_TYPE, $ax.constants.DYNAMIC_PANEL_TYPE],
    ...
    var _postResize = $ax.postResize = function(e) {
        $ax.setjBrowserEvent(e);
        return fireEventThroughcontainer px-md-5s('onResize', undefined, false, [$ax.constants.PAGE_TYPE, $ax.constants.REFERENCE_DIAGRAM_OBJECT_TYPE, $ax.constants.DYNAMIC_PANEL_TYPE, $ax.constants.REPEATER],
            [$ax.constants.PAGE_TYPE, $ax.constants.REFERENCE_DIAGRAM_OBJECT_TYPE]);
    };
    ...
    var fireEventThroughcontainer px-md-5s = function(eventName, objects, synthetic, searchFilter, callFilter, path, itemId) {
        ...
        if(!objects) {
            ...
            if(searchFilter.indexOf($ax.constants.PAGE_TYPE) != -1) fireEventThroughcontainer px-md-5s(eventName, $ax.pageData.page.diagram.objects, synthetic, searchFilter, callFilter);
        ...
        for(var i = 0; i < objects.length; i++) {
            ...
            if($ax.public.fn.IsReferenceDiagramObject(obj.type)) {
                ...
                if(searchFilter.indexOf($ax.constants.REFERENCE_DIAGRAM_OBJECT_TYPE) != -1) fireEventThroughcontainer px-md-5s(eventName, $ax.pageData.masters[obj.masterId].diagram.objects, synthetic, searchFilter, callFilter, pathCopy, itemId);
                ...
                if(searchFilter.indexOf($ax.constants.DYNAMIC_PANEL_TYPE) != -1) {
                    ...
                    for(var j = 0; j < diagrams.length; j++) {
                        fireEventThroughcontainer px-md-5s(eventName, diagrams[j].objects, synthetic, searchFilter, callFilter, path, itemId);
                    }
                }
                ...
                if(searchFilter.indexOf($ax.constants.REPEATER) != -1) {
                    ...
                    for(var j = 0; j < itemIds.length; j++) {
                        fireEventThroughcontainer px-md-5s(eventName, obj.objects, synthetic, searchFilter, callFilter, path, itemIds[j]);
                    }
                }
                ...
                if(obj.objs && obj.objs.length > 0) {
                    fireEventThroughcontainer px-md-5s(eventName, obj.objs, synthetic, searchFilter, callFilter, path, itemId);
                }
            }
        }
        ...
        for(key in PAGE_AXURE_TO_JQUERY_EVENT_NAMES) {
            ...
            (function(axureName) {
                ...
                $(jObj)[actionName](function (e) {
                    $ax.setjBrowserEvent(e);
                    return fireEventThroughcontainer px-md-5s(axureName, undefined, false, [$ax.constants.PAGE_TYPE, $ax.constants.REFERENCE_DIAGRAM_OBJECT_TYPE, $ax.constants.DYNAMIC_PANEL_TYPE, $ax.constants.REPEATER],
                        [$ax.constants.PAGE_TYPE, $ax.constants.REFERENCE_DIAGRAM_OBJECT_TYPE]);
                });
            })(key);
        }
