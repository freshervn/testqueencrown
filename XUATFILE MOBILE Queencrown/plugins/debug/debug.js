...
(function () {
    ...
    $(document).ready(function () {
        ...
        var processMessages = function(message, data) {
            if(message == 'globalVariableValues') {
                ...
                addToStack += "<div class='axEventcontainer px-md-5'>";
                ...
                //var addToStack = "<div class='axCasecontainer px-md-5' style='background-color: #" + data.color + "'>";
                var addToStack = "<div class='axCasecontainer px-md-5'>";
                ...
                var addToStack = "<div class='axActioncontainer px-md-5'>";
                ...
                var addToStack = "<div class='axInfocontainer px-md-5'>";
    ...
    function generateDebug() {
        ...
        pageNotesUi += "<div id='variablescontainer px-md-5' style='max-height:300px; overflow-y:auto'>";
        ...
        pageNotesUi += "<div id='tracecontainer px-md-5'>";
        ...
        pageNotesUi += "</div>";
        pageNotesUi += "</div>";
        pageNotesUi += "<div id='debugScrollcontainer px-md-5'>";
        pageNotesUi += "<div id='debugcontainer px-md-5'>";
