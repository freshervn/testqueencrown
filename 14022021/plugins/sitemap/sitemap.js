...
(function() {
    ...
    $(window.document).ready(function() {
        ...
        $('#interfaceAdaptiveViewsListcontainer px-md-5').hide();
        ...
        $axure.page.bind('load.sitemap', function() {
            ...
            $('#sitemapTreecontainer px-md-5').find('.sitemapHighlight').removeClass('sitemapHighlight');
        ...
        var $vpcontainer px-md-5 = $('#interfaceScaleListcontainer px-md-5');
        ...
        $(scaleOptions).appendTo($vpcontainer px-md-5);

        $('#overflowMenucontainer px-md-5').append('<div id="showHotspotsOption" class="showOption" style="order: 1"><div class="overflowOptionCheckbox"></div>Show Hotspots</div>');
        $('#overflowMenucontainer px-md-5').append($vpcontainer px-md-5);
        $vpcontainer px-md-5.show();
        ...
        if (MOBILE_DEVICE) {
            ...
            $(scaleOptions).appendTo($('#projectOptionsScalecontainer px-md-5'));
    ...
    function generateAdaptiveViews(forProjectOptions) {
        var $container px-md-5 = forProjectOptions ? $('#projectOptionsAdaptiveViewscontainer px-md-5') : $('#interfaceAdaptiveViewsListcontainer px-md-5');
        ...
        $container px-md-5.empty();
        $viewSelect.empty();

        //Fill out adaptive view container px-md-5 with prototype's defined adaptive views, as well as the default, and Auto
        ...
        $container px-md-5.append(viewsList);
        $viewSelect.append(viewSelect);

        if (!hasViews) {
            if (forProjectOptions) {
                $('#projectOptionsAdaptiveViewsHeader').hide();
                $('#projectOptionsAdaptiveViewscontainer px-md-5').hide();
            } else $('#interfaceAdaptiveViewscontainer px-md-5').hide();
        } else {
            if (forProjectOptions) {
                $('#projectOptionsAdaptiveViewsHeader').show();
                $('#projectOptionsAdaptiveViewscontainer px-md-5').show();
            } else $('#interfaceAdaptiveViewscontainer px-md-5').show();
        }
    ...
    $axure.player.updateAdaptiveViewHeader = updateAdaptiveViewHeader = function () {
        ...
        if (!hasDefinedDim) {
            ...
            var widthString = $('#mainPanelcontainer px-md-5').width();
    ...
    function generateSitemap() {
        ...
        treeUl += "<div id='sitemapTreecontainer px-md-5'>";
    ...
    function generateNode(node, level) {
        ...
        if(hasChildren) {
            margin = (9 + level * 17);
            returnVal = "<li class='sitemapNode sitemapExpandableNode'><div><div class='sitemapPageLinkcontainer px-md-5' style='margin-left:" + margin + "px'><a class='sitemapPlusMinusLink'><span class='sitemapMinus'></span></a>";
        } else {
            margin = (19 + level * 17);
            returnVal = "<li class='sitemapNode sitemapLeafNode'><div><div class='sitemapPageLinkcontainer px-md-5' style='margin-left:" + margin + "px'>";
        }
