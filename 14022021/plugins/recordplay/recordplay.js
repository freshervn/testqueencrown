    ...
    var getOneRecording = function(recordingItem) {
        $.ajax({
            ...
            success: function(response) {
                        ...
                        var axRecordingcontainer px-md-5 = $('#recordingcontainer px-md-5').find('li').filter('.recordingRootNode');
                        axRecordingcontainer px-md-5.append(_formAxRecordingBranch(response));
...
//            }            
    ...
    var _stopClick = function(event) {
        var axRecording, axObjectDictionary, axRecordingcontainer px-md-5, transmissionFields;
        $('#sitemapLinkscontainer px-md-5').toggle();
        if($('#recordButton').is('.recordPlayButtonSelected')) {
            ...
            axRecordingcontainer px-md-5 = $('#recordingcontainer px-md-5').find('li').filter('.recordingRootNode');
            axRecordingcontainer px-md-5.append(_formAxRecordingBranch(axRecording));
    ...
    var _formAxRecordingBranch = function(axRecording) {
        ...
        recordPlayUi += '<div class="recordingcontainer px-md-5" style="margin-left:15px">';
        ...
        for(eventID in axRecording.eventList) {
            ...
            recordPlayUi += '<div class="recordingEventcontainer px-md-5" style="margin-left:44px">';
            var eventID = axRecording['recordingId'] + '_' + eventObject.timeStamp;
...
//            recordPlayUi += 'cursor: ' + eventObject.eventInfo.cursor.x + ',' + eventObject.eventInfo.cursor.y + '<br/>';
    ...
    var _generateRecordPlay = function() {
        var recordPlayUi = "<div id='recordPlaycontainer px-md-5'>";
        ...
        recordPlayUi += "<div id='recordingcontainer px-md-5'><li class='recordingNode recordingRootNode'></li></div>";
        recordPlayUi += "</div>";
