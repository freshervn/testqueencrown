...
$.fn.splitter = function(args){
   ...
   return this.each(function() {
      ...
      var panes = $(">*", splitter[0]).css({
         position: "absolute",          // positioned inside splitter container px-md-5
      ...
      if ( opts.anchorToWindow ) {
         // Account for margin or border on the splitter container px-md-5 and enforce min height
      ...
      splitter.bind("resize", function(e, size){
         ...
         // Determine new width/height of splitter container px-md-5
