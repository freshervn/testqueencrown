...
//                    $ax.event.raiseSyntheticEvent(elementId, "onMove");
                    $ax.visibility.pushcontainer px-md-5(elementId, false);

                    options.onComplete = function () {
                        _fireAnimationFromQueue(elementId, queueTypes.move);
                        $ax.visibility.popcontainer px-md-5(elementId, false);
                    };
            ...
            //            type: queueTypes.move,
            //            func: function () {
            //                // Nop, while trying to move as container px-md-5
...
//                $ax.event.raiseSyntheticEvent(elementId, "onMove");
                        ...
                        func: function() {
                            ...
                            if(isLayer) {
                                ...
                                var onComplete = function() {
                                    if(--completeCount == 0) $ax.visibility.popcontainer px-md-5(elementId, false);
                                };
            ...
            animations.push({
                ...
                func: function() {
                    ...
                    if(deltaHeight != 0 || deltaWidth != 0) {
                        ...
                        if(rootLayer) $ax.visibility.pushcontainer px-md-5(rootLayer, false);
    ...
    var _getCssForResizingWidget = function (elementId, eventInfo, anchor, newWidth, newHeight, oldWidth, oldHeight, delta, stop, handleMove) {
        ...
        // If it is pinned, but temporarily not fixed because it is wrappen in a container px-md-5, then just make sure to anchor it correctly
