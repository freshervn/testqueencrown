$axure.internal(function($ax) {
    ...
    //    if (parentId && $ax.visibility.iscontainer px-md-5(parentId)) return;
    ...
    //    parentId = $ax.visibility.getWidgetFromcontainer px-md-5(textObjParent.attr('id'));
    ...
    //        var container px-md-5Height = height * bottomParam - relativeTop;
    ...
    //        if(vAlign == "middle")
    //            newTop = _roundToEven(relativeTop + (container px-md-5Height - textHeight + paddingTop - paddingBottom) / 2);
    //        else if(vAlign == "bottom")
    //            newTop = _roundToEven(relativeTop + container px-md-5Height - textHeight - paddingBottom);
    ...
    //    if(vAlign == "middle") newTop = _roundToEven(relativeTop + (container px-md-5Height - textHeight + paddingTop - paddingBottom) / 2);
    //    else if(vAlign == "bottom") newTop = _roundToEven(relativeTop + container px-md-5Height - textHeight - paddingBottom);
    //    else newTop = _roundToEven(paddingTop + relativeTop);
    //    var vertChange = oldTop != newTop;
